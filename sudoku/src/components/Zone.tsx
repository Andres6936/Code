    ...
    return (
        <div className={"display:flex flex:col flex-grow:1 m:0.1rem"}>
            <div className={"display:flex flex:row flex-grow:1"}>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 0, y: 0}}/>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 1, y: 0}}/>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 2, y: 0}}/>
            </div>
            <div className={"display:flex flex:row flex-grow:1"}>
            ...
            <div className={"display:flex flex:row flex-grow:1"}>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 0, y: 2}}/>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 1, y: 2}}/>
                <InputCell zone={zone} coordinateOfZone={props.coordinate} coordinate={{x: 2, y: 2}}/>
            </div>
        </div>
    )
}